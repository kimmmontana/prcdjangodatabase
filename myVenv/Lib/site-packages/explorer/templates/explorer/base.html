...
<head>
    ...
    <title>{% trans "PRC" %}{% if query %} - {{ query.title }}{% elif title %} - {{ title }}{% endif %}</title>
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="{% url 'explorer_index' %}">{% trans "Professional Regulation Commission" %}</a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="text-muted">
                        Click here to add/delete data: <a href="http://localhost:8000/admin/">PRC Admin</a> 
